# Write scenario: write_iclass_legacy_success
# iCLASS Legacy (type 17): standard key succeeds during scan
# Write phase: wrbl succeeds, verify reads back matching data
#
...
'''),
    # --- Write phase ---
    # writeDataBlock sends: hf iclass wrbl b 6 d DATA k KEY
...
'''),
    ...
    'hf iclass calcnewkey': (0, '''[usb] pm3 --> hf iclass calcnewkey o 2020666666668888 n AFA785A7DAB33378
