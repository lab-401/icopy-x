# MF Classic 1K: fchk none → darkside key → nested "not vulnerable" → hardnested key → read all
SCENARIO_RESPONSES = {
...
'''),
    'hf mf hardnested': (0, '''[usb] pm3 --> hf mf hardnested 1 0 A a0a1a2a3a4a5 1 15 B
