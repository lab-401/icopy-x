# MF Classic 1K: every rdsc gets Auth error - Read Failed
# Console test: RIGHT pressed on RESULT screen (failure path)
# Fixture data identical to read_mf1k_all_sectors_fail
SCENARIO_RESPONSES = {
