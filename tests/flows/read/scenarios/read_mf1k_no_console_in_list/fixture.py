# MF Classic 1K: all default keys, all sectors readable
# Negative test: RIGHT pressed in ReadListActivity before starting a read
# Fixture data identical to read_mf1k_all_default_keys
SCENARIO_RESPONSES = {
    'hf 14a info': (1, '''
'''),
