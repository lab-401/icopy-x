# Auto-Copy scenario: autocopy_lf_securakey
# LF SECURAKEY (type 14): full auto-copy pipeline with T55XX DRM + verify
...
#   hf sea (passthrough)
#   lf sea (Valid Securakey ID)
#   lf securakey read x2
...
'''),
    'lf securakey read': (1, '''[+] Valid Securakey ID found!
...
'''),
    ...
    'lf securakey clone': (1, '''[+] Preparing to clone Securakey to T55x7
'''),
