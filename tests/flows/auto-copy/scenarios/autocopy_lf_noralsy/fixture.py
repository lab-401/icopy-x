# Auto-Copy scenario: autocopy_lf_noralsy
# LF NORALSY (type 33): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf sea': (1, '''[+] Valid Noralsy ID found!
[+] Card ID: 12345678
'''),
    'lf noralsy read': (1, '''[+] Noralsy - Card: 12345678, Raw: 1234567800112233
'''),
    'lf t55xx wipe': (1, '''
