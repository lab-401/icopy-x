# Auto-Copy scenario: autocopy_lf_gprox
# LF GPROX (type 13): full auto-copy pipeline with T55XX DRM + verify
...
#   hf sea (passthrough)
#   lf sea (Valid Guardall G-Prox II)
#   lf gproxii read x2
...
'''),
    'lf sea': (1, '''[+] Valid Guardall G-Prox II ID found!
[+] FC: 123, CN: 4567
[+] Raw: 0880088008800880
'''),
    'lf gproxii read': (1, '''[+] Valid Guardall G-Prox II ID found!
[+] FC: 123, CN: 4567
[+] Raw: 0880088008800880
'''),
    'lf t55xx wipe': (1, '''
...
'''),
    ...
    'lf gproxii clone': (1, '''[+] Preparing to clone G-Prox II to T55x7
'''),
