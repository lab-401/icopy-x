...
# Auto-Copy scenario: MF Classic 1K console during read
# Console test: RIGHT pressed during READ_IN_PROGRESS phase of auto-copy
# Fixture data identical to autocopy_mf1k_happy
#
