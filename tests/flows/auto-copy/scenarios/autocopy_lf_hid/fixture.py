# Auto-Copy scenario: autocopy_lf_hid
# LF HID (type 9): full auto-copy pipeline with T55XX DRM + verify
...
#   hf sea (passthrough)
#   lf sea (Valid HID Prox ID found)
#   lf hid read x2
...
'''),
    'lf hid read': (1, '''[+] Valid HID Prox ID found!
