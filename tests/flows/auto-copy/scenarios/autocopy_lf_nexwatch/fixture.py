...
# LF NEXWATCH (type 45): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf sea': (1, '''[+] Valid NexWatch ID found!
[+] Raw: AABBCCDD00112233
'''),
    'lf nexwatch read': (1, '''[+] NexWatch, Quadrakey
[+] ID: AABBCCDD00112233
...
'''),
    ...
    'lf nexwatch clone': (1, '''[+] Preparing to clone NexWatch to T55x7
'''),
