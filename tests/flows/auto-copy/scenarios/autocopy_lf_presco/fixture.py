# Auto-Copy scenario: autocopy_lf_presco
# LF PRESCO (type 36): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf sea': (1, '''[+] Valid Presco ID found!
[+] Card ID: 12345678
'''),
    'lf presco read': (1, '''[+] Presco - Card: 12345678, Raw: 123456780011223344556677
'''),
    'lf t55xx wipe': (1, '''
...
'''),
    'lf t55xx write b 3': (1, '''[=] Writing page 0  block: 03  data: 0x44556677
'''),
