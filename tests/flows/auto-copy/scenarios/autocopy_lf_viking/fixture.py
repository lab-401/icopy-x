# Auto-Copy scenario: autocopy_lf_viking
# LF VIKING (type 15): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf viking read': (1, '''[+] Viking - Card 12345678, Raw: 1234567800112233
'''),
    'lf t55xx wipe': (1, '''
