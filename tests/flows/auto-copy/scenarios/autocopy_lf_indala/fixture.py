# Auto-Copy scenario: autocopy_lf_indala
# LF INDALA (type 10): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf indala read': (1, '''[+] Valid Indala ID found!
...
'''),
    ...
    'lf indala clone': (1, '''[+] Preparing to clone Indala to T55x7
'''),
