# Auto-Copy scenario: autocopy_lf_jablotron
# LF JABLOTRON (type 30): full auto-copy pipeline with T55XX DRM + verify
...
#   hf sea (passthrough)
#   lf sea (Valid Jablotron ID)
#   lf jablotron read x2
...
'''),
    'lf jablotron read': (1, '''[+] Jablotron - Card: FF010201234568, Raw: 1234567800112233
'''),
    'lf t55xx wipe': (1, '''
