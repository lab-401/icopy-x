# Auto-Copy scenario: autocopy_lf_pac
# LF PAC (type 34): full auto-copy pipeline with T55XX DRM + verify
...
'''),
    'lf pac read': (1, '''[+] PAC/Stanley - Card: FF01020304050607, Raw: AABBCCDD00112233
'''),
    'lf t55xx wipe': (1, '''
...
'''),
    ...
    'lf pac clone': (1, '''[+] Preparing to clone PAC/Stanley to T55x7
'''),
