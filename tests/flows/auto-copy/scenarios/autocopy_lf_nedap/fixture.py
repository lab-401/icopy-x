# Auto-Copy scenario: autocopy_lf_nedap
# LF NEDAP (type 32): full auto-copy pipeline with T55XX DRM + verify
# Ground truth: V1090_AUTOCOPY_FLOW_COMPLETE.md Section 4.3-4.6 + awid_write_trace_20260328.txt
# NEDAP uses write_nedap() in lfwrite.so which does T5577 raw block writes
#
# PM3 command sequence:
#   hf 14a info (passthrough)
#   hf sea (passthrough)
#   lf sea (Valid NEDAP ID)
#   lf nedap read x2
...
'''),
    'lf sea': (1, '''[+] Valid NEDAP ID found!
[+] Card ID: 12345678
'''),
    'lf nedap read': (1, '''[+] NEDAP - Card: 12345678, Raw: 1234567800112233
'''),
    'lf t55xx wipe': (1, '''
